...
class HealthDashboard {
    ...
    setupIndividualDownloadButtons() {
        const chartConfigs = [
            ...
            { id: 'radarmyDiv', name: 'The Sum total Volume of Health Condition Searches from 2004- 2017' },
            { id: 'radarmyDiv2', name: 'The Sum total Volume of 10 Leading Causes of Death Per 100,000 Population from 2004-2017' },
            { id: 'line-chart3', name: 'Leading Causes of Death Trends' }
        ];

        chartConfigs.forEach(config => {
            this.addDownloadButton(config.id, config.name);
        });
    }

    addDownloadButton(chartId, chartName) {
